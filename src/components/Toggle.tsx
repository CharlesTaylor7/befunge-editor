...
export default function Toggle(props: Props) {
  ...
  return (
    <label data-testid={props.testId} className="relative inline-flex items-center cursor-pointer">
      <input type="checkbox" value="" className="peer sr-only" onChange={(e) => {
        onToggle(e.target.checked);
        let store = Alpine.store("legacy") as AppState;
        store.gridEnabled == !store.gridEnabled;
      }} 
      />
